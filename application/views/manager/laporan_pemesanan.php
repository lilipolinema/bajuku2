			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Data Pemesanan</h5><br>
							...
							<tbody>
								<?php
					                foreach($pemesanan as $p){?>
					                    <tr>
					                    	<td class="table-plus"><?= $p['id_pemesanan']; ?></td>
					                        ...
					                        <td>
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" disabled href="<?= base_url();?>index.php/manager/detailpemesanan/<?= $p['id_pemesanan'];?>"><i class="fa fa-eye"></i> Detail</a>
													</div>
												</div>
											</td>
					                    </tr>
