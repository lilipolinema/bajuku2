		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
			...
			<div class="color-quality">
				<div class="color-quality-right">
					...
					<select name="jumlah" id="country1" onchange="change_country(this.value)" class="frm-field required sect">
			...
			<div class="occasional">
				<h5>Ukuran</h5>
				<div class="colr">
					<label class="radio"><input type="radio" name="radio" value="S"><i></i>S</label>
				</div>
				<div class="colr">
					<label class="radio"><input type="radio" name="radio" value="M" checked=""><i></i>M</label>
				</div>
				<div class="colr">
					<label class="radio"><input type="radio" name="radio" value="L"><i></i>L</label>
				</div>
				<div class="colr">
					<label class="radio"><input type="radio" name="radio" value="XL"><i></i>XL</label>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="occasion-cart">
				<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
					<a class="button" href="#" data-toggle="modal" data-target="#login">Beli Sekarang</a>
				</div>																			
			</div>					
		</div>
