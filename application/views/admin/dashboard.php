		...
		<div class="customscroll customscroll-10-p height-100-p xs-pd-20-10 pd-ltr-20">
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?php echo base_url();?>indexx.php/admin/dashboard">Home</a></li>
			...
			<div class="row" align="center">
				<div class="col-4" style="background-color: #F4D7F7; padding-top: 30; padding-bottom: 30; margin-left: 17">
					<img src="<?php echo base_url();?>assets/admin/src/images/transaction1.png">
					<h3><b>Cepat</b></h3>
					<br><p>Proses transaksi yang sangat cepat</p>
				</div>
				<div class="col-3" style="background-color: #EBF7DF; padding-top: 30; padding-bottom: 30; margin-left: 35">
					<img src="<?php echo base_url();?>assets/admin/src/images/money_bag.png">
					<h3><b>Hemat</b></h3>
					<br><p>Harga Produk  sangat terjangkau</p>
				</div>
				<div class="col-4" style="background-color: #D7EEF7; padding-top: 30; padding-bottom: 30; margin-left: 35">
					...
					<h3><b>Nyaman</b></h3>
					<br><p>Platform online shopping yang sangat nyaman</p>
				</div>
			</div>
