...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info">Konfirmasi <span>Pembayaran Bank Transfer</span></h3>	
		<div class='o-layout__item u-3of4'>
<div class='c-page-content js-page-content'>
<p align="justify">Cek cara melakukan konfirmasi pembayaran di App dan Desktop, sebagai berikut:</p>
				<div class="clearfix"></div>	
					...
					<!--/tab_one-->
					   <div class="tab1">
							<div class="single_page_agile_its_w3ls">
							   <p>1. Klik icon pada bagian 'Akun Saya' di bagian kanan atas lalu klik 'Konfirmasi Transfer'</p>
							   <p class="w3ls_para">2. Lakukan konfirmasi pembayaran dengan memasukkan detil Lakukan konfirmasi pembayaran dengan memasukkan detil Nomor Order, Bank Anda, Bank Tujuan, Rekening Atas Nama (Nama Pemiik Rekening yang digunakan untuk Transfer) serta informasi secara lengkap detail pembayaran Anda dan Jangan Lupa untuk untuk menyertakan bukti pembayaranya . Setelah detail informasi telah diisi, mohon klik tombol 'Konfirmasi' di bagian bawah</p>
							   <p class="w3ls_para">3. Anda akan menerima email yang menyatakan bahwa order Anda telah dikonfirmasi</p>
							</div>
						</div>
						<!--//tab_one-->
						<hr>
