...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info">Customer <span>Service</span></h3>	
	    ...
	    <div class="container">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:info@example.com">customer_service@bajuku.com</a><span>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
