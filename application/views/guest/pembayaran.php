...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info">Pilihan <span>Pembayaran</span></h3>	
		<div class='o-layout__item u-3of4'>
<div class='c-page-content js-page-content'>
<p align="justify">BajuKu menyediakan beberapa opsi pembayaran demi kenyamanan pengalaman berbelanja Anda. Cek lebih lanjut opsi pembayaran yang dapat Anda pilih:</p>
				<div class="clearfix"></div>	
					...
					<!--/tab_one-->
					   <div class="tab1">
							<div class="single_page_agile_its_w3ls">
							   <p>1. Pembayaran diberikan kepada kurir saat menerima barang</p>
							   <p class="w3ls_para">2. PENTING: Tidak diperkenankan untuk mencoba produk terlebih dahulu sebelum melakukan pembayaran</p>
							   <p class="w3ls_para">3. Jika Anda ingin melakukan penukaran, silahkan melakukan pembayaran terlebih dahulu lalu silahkan isi form pengembalian  </p>
							</div>
						</div>
						<!--//tab_one-->
						<div class="tab2">
							<div class="single_page_agile_its_w3ls">
							   <p>1. Bank Transfer (Konfirmasi Manual) adalah tipe pembayaran yang akan diverifikasi secara manual oleh tim kami dalam waktu 1 x 24 jam. Jika setelah 1 x 24 jam pembayaran tidak diterima, maka BajuKu berhak melakukan pembatalan terhadap order tersebut</p>
							   <p class="w3ls_para">2. Lakukan konfirmasi pembayaran untuk menghindari pembatalan otomatis oleh sistem dan mempercepat proses pesanan Anda </p>
							   <p class="w3ls_para">3. Lakukan pembayaran dengan transfer ke salah satu rekening BajuKu 
							</div>
						</div>
						<!--//tab_one-->
						<div class="tab3">
							<div class="single_page_agile_its_w3ls">
							   <p>1. Pilih metode pembayaran, contoh transer bank Mandiri. Maka akan muncul nomor virtual account Mandiri, kemudian catat dan lanjutkan pesanan </p>
							   <p class="w3ls_para">2. Buka aplikasi OVO, pilih menu Transfer selanjutnya tap Rekening Bank > bank Mandiri > Isikan nomor rekening dari BajuKu lalu Transfer</p>
							</div>
						</div>
					</div>
				</div>	
