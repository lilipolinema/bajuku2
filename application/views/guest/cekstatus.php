...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info">Status Pengiriman <span>Pesanan</span></h3>	
		<div class='o-layout__item u-3of4'>
<div class='c-page-content js-page-content'>
<p align="justify">Berikut beberapa informasi mengenai status pengiriman pesanan::</p>
				<div class="clearfix"></div>	
					...
					<!--/tab_one-->
					   <div class="tab1">
							<div class="single_page_agile_its_w3ls">
							   <p>1. Login ke akun BajuKu</p>
							   <p class="w3ls_para">2. Klik icon Transaksi</p>
							   <p class="w3ls_para">3. Klik tab Pembelian</p>
							   <p class="w3ls_para">4. Pilih Dikirim pada bagian Pilih Status. </p>
							   <p class="w3ls_para">5. Klik tombol Lihat Detail. </p>
							   <p class="w3ls_para">6. KKlik Histori Pengiriman untuk melihat detail status pengiriman. </p>
							</div>
							</div>
						</div>
						<!--//tab_one-->
