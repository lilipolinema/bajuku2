				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current">
						<a class="menu__link" href="<?php echo base_url()?>index.php/user/home/">Home <span class="sr-only">(current)</span></a>
					</li>
					<li class=" menu__item">
					...
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							...
							<img src='<?php echo base_url("assets/images/".$w->gambar_produk);?>' alt="" class="pro-image-back">
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="<?php echo base_url()."index.php/user/home/detail_produk/". $w->id_produk; ?>" class="link-product-add-cart">Lihat Produk</a>
									</div>
								</div>
							<span class="product-new-top">Baru</span>										
						</div>
						<div class="item-info-product ">
							<h4><a href="<?php echo base_url()."index.php/user/home/detail_produk/". $w->id_produk; ?>"><?php echo $w->nama_produk;?></a></h4>
							<div class="info-product-price">
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>B</span>bajuku </a></h2>
		</div>
