...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<h3 class="wthree_text_info">Pembatalan <span>Pesanan</span></h3>	
		<div class='o-layout__item u-3of4'>
<div class='c-page-content js-page-content'>
<p align="justify">Berikut langkah membatalkan pesanan:</p>
				<div class="clearfix"></div>	
					...
					<!--/tab_one-->
					   <div class="tab1">
							<div class="single_page_agile_its_w3ls">
							   <p>1. Buka halaman Detail Transaksi, lalu klik tombol Batalkan Transaksi</p>
							   <p class="w3ls_para">2. Isi alasan pembatalan, lalu klik tombol Konfirmasi</p>
							   <p class="w3ls_para">3. Pesanan akan otomatis berhasil dibatalkan jika pembeli belum membayar pesanan</p>
							   <p class="w3ls_para">3. Bagi pembeli yang telah membayar pesanan dan status transaksi belum diproses, jika ingin membatalkan pesanan dalam waktu 15 menit setelah pembayaran terverifikasi maka dana akan langsung dikembalikan sesuai dengan metode pembayaran yang digunakan. Namun apabila sudah lebih dari 15 menit, maka pembeli dapat menunggu konfirmasi persetujuan pembatalan pesanan. Jika pelapak menyetujui, pesanan otomatis berhasil dibatalkan. Status transaksi menjadi Dibatalkan </p>
							</div>
						</div>
						<!--//tab_one-->
						 <hr>
