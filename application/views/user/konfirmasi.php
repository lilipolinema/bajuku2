...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		...
		<div class="col-md-8 single-right-left contact-form">
			<form action="<?php echo base_url()?>index.php/user/transaksi/konfirm_bayar" method="post">
			<div class="styled-input agile-styled-input-top">
				<input type="text" name="id_order" value="<?php echo $d->id_pemesanan; ?>" hidden>
				<input type="text" name="kode">
				<label>Masukkan kode bayar disamping : <?php echo $d->kode_bayar;?></label>
				<span></span>
			</div>
		<?php } ?>
			<input type="submit" class="button" value="Submit Kode">
			</form>
		</div>																			
	</div>					
</div>
